...
public class HookFlutterClipBordUtil {
    ...
    public static class IClipboardInvocationHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            Log.d("IClipboardInvocationHandler", "invoke "+method.getName());
            // flutter输入框会调用获取剪切板 合规问题屏蔽掉
            if ("getClipboardData".equals(method.getName())) {
                Log.d("IClipboardInvocationHandler", "getClipboardData");
                return "";
            }
            if ("clipboardHasStrings".equals(method.getName())) {
                Log.d("IClipboardInvocationHandler", "clipboardHasStrings");
                return false;
            }
