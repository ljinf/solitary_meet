  ...
  void listener() {
    controller.phoneController.addListener(() {
      if (controller.phoneController.text.length >= 11 &&
          controller.codeController.text.length >= 6) {
        setState(() {
          enable = true;
        });
      } else {
                ...
                children: [
                    ...
                    decoration: const InputDecoration(
                      ...
                      enabledBorder: UnderlineInputBorder(
                        borderSide: BorderSide(
                            color: Color(0xFFE5E6EB), width: 0.5), // 设置下划线颜色
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          controller.sendCode(controller.phoneController.text);
                        },
                        child: Container(
                          width: 100,
              ...
              child: ElevatedButton(
                style: ButtonStyle(
                  ...
                  backgroundColor: WidgetStateProperty.all(enable
                      ...
                      : const Color(0x881C212A)),
                ),
                onPressed: () {
                  controller.login(controller.phoneController.text,
